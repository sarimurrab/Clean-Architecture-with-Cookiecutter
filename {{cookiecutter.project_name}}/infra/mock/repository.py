...
class Mock{{cookiecutter.api_2_for_name}}Repository({{cookiecutter.api_2_for_name}}Repository):
    _users: List[User] = []

    def __init__(self):
        education_{{cookiecutter.api_2_for_name}} = EducationExtra{{cookiecutter.api_2_for_name}}(school="MAIT", department="CSE")
        career_{{cookiecutter.api_2_for_name}} = CareerExtra{{cookiecutter.api_2_for_name}}(career="Developer", job_title="Fullstack Developer")
        member = Member(
            id=111,
            user_name="SRM",
            user_status="enabled",
            basic_{{cookiecutter.api_2_for_name}}=UserBasic{{cookiecutter.api_2_for_name}}(real_name="Hello SRM", gender="Male", birthday=""),
        ...
        newcomer = Newcomer(
            ...
            user_name="Nancy",
            user_status="enabled",
            basic_{{cookiecutter.api_2_for_name}}=UserBasic{{cookiecutter.api_2_for_name}}(real_name="Hello Nancy", gender="Female", birthday=""),
